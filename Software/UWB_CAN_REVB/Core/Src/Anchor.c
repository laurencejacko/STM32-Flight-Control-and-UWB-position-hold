...
#define AnchorTotal 5

#define SOURCE_ADDRESS_IDX 5
#define DESTINATION_ADDRESS_IDX 7

static uint8_t address_of_A[] = { 'A', 1 }; //{'A', 1};
static uint8_t address_of_B[] = { 'B', 2 }; //{'B', 2};
static uint8_t address_of_C[] = { 'C', 3 }; //{'D', 4};
static uint8_t address_of_D[] = { 'D', 4 }; //{'C', 3};
static uint8_t address_of_E[] = { 'E', 5 }; //{'D', 4};
static uint8_t address_of_F[] = { 'F', 6 }; //{'C', 3};


#if AnchorIndex == 0 // A
#define RNG_DELAY_MS 90
#define AggregateDelay 32837


#elif AnchorIndex == 1 //B
#define RNG_DELAY_MS 94
#define AggregateDelay 32829

#elif AnchorIndex == 2 //C
#define RNG_DELAY_MS 98
#define AggregateDelay 32816
//#define AggregateDelay 0


#elif AnchorIndex == 3 //D
#define RNG_DELAY_MS 102
#define AggregateDelay 32818
//#define AggregateDelay 0

#elif AnchorIndex == 4 //E
#define RNG_DELAY_MS 106
#define AggregateDelay 32841


#elif AnchorIndex == 5 //F
#define RNG_DELAY_MS 142
#define AggregateDelay 32770


#elif AnchorIndex == TAG
#define RNG_DELAY_MS 110
#define AggregateDelay 32774

#endif

//#if AnchorIndex == 0 // A
//#define RNG_DELAY_MS 122
//#define AggregateDelay 32994
//
//
//#elif AnchorIndex == 1 //B
//#define RNG_DELAY_MS 126
//#define AggregateDelay 33035
//
//#elif AnchorIndex == 2 //C
//#define RNG_DELAY_MS 130
//#define AggregateDelay 32722
//
//
//#elif AnchorIndex == 3 //D
//#define RNG_DELAY_MS 134
//#define AggregateDelay 32593
//
//#elif AnchorIndex == 4 //E
//#define RNG_DELAY_MS 138
//#define AggregateDelay 32875
//
//
//#elif AnchorIndex == 5 //F
//#define RNG_DELAY_MS 142
...
//
//#elif AnchorIndex == TAG
//#define RNG_DELAY_MS 146
//#define AggregateDelay 32757
//
//#endif
...
//change this everytime flash code to new anchor
...
int ds_twr_initiator(void) {
	...
	if (AnchorIndex == 0) { //amend the address depending on the anchor definition
			...
			} else if ((AnchorIndex == 5)||(AnchorIndex==TAG)) {
	...
	while (1) {
		...
		/*
		 * Anchor must listen for blink message until it receives correct index from (blink number % 4 )
		 *
